...
public abstract class MapReferences<I, K> {
  ...
  public static abstract class Callee<I, K> {
    ...
    public synchronized MapReferences.Callee.Component<I, K> _newComponent(final MapReferences.Callee.Requires<I, K> b, final boolean start) {
      ...
      this.init = true;
      MapReferences.Callee.ComponentImpl<I, K>  _comp = new MapReferences.Callee.ComponentImpl<I, K>(this, b, true);
      if (start) {
      	_comp.start();
      }
      return _comp;
  ...
  public static abstract class CalleeKeyPort<I, K> {
    ...
    public synchronized MapReferences.CalleeKeyPort.Component<I, K> _newComponent(final MapReferences.CalleeKeyPort.Requires<I, K> b, final boolean start) {
      ...
      this.init = true;
      MapReferences.CalleeKeyPort.ComponentImpl<I, K>  _comp = new MapReferences.CalleeKeyPort.ComponentImpl<I, K>(this, b, true);
      if (start) {
      	_comp.start();
      }
      return _comp;
  ...
  public static abstract class Caller<I, K> {
    ...
    public synchronized MapReferences.Caller.Component<I, K> _newComponent(final MapReferences.Caller.Requires<I, K> b, final boolean start) {
      ...
      this.init = true;
      MapReferences.Caller.ComponentImpl<I, K>  _comp = new MapReferences.Caller.ComponentImpl<I, K>(this, b, true);
      if (start) {
      	_comp.start();
      }
      return _comp;
  ...
  public synchronized MapReferences.Component<I, K> _newComponent(final MapReferences.Requires<I, K> b, final boolean start) {
    ...
    this.init = true;
    MapReferences.ComponentImpl<I, K>  _comp = new MapReferences.ComponentImpl<I, K>(this, b, true);
    if (start) {
    	_comp.start();
    }
    return _comp;
  ...
  protected MapReferences.Caller.Component<I, K> newCaller() {
    MapReferences.Caller<I, K> _implem = _createImplementationOfCaller();
    return _implem._newComponent(new MapReferences.Caller.Requires<I, K>() {},true);
  }
