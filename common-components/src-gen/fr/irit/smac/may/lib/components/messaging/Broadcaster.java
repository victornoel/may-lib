...
public abstract class Broadcaster<T, Ref> {
	...
	public static abstract class Agent<T, Ref> {
		 ...
		 * This is not meant to be called from the outside by hand.
		 */
		protected Broadcaster.Component<T, Ref> eco_self() {
		 ...
		 * This is not meant to be called from the outside.
		 */
		protected fr.irit.smac.may.lib.interfaces.Send<T, Ref> eco_deposit() {
			assert this.ecosystemComponent != null;
			return this.ecosystemComponent.bridge.deposit();
		};
