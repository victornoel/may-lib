...
public abstract class ClassicNamedAgentComponent<Msg, Ref> {
  ...
  @SuppressWarnings("all")
  public static class ComponentImpl<Msg, Ref> implements fr.irit.smac.may.lib.classic.named.ClassicNamedAgentComponent.Component<Msg,Ref>, fr.irit.smac.may.lib.classic.named.ClassicNamedAgentComponent.Parts<Msg,Ref> {
    ...
    public ComponentImpl(final ClassicNamedAgentComponent<Msg,Ref> implem, final fr.irit.smac.may.lib.classic.named.ClassicNamedAgentComponent.Requires<Msg,Ref> b, final boolean initMakes) {
      this.bridge = b;
    ...
    private fr.irit.smac.may.lib.classic.named.ClassicNamedBehaviour.Component<Msg,Ref> beh;
  ...
  public fr.irit.smac.may.lib.classic.named.ClassicNamedAgentComponent.Component<Msg,Ref> newComponent(final fr.irit.smac.may.lib.classic.named.ClassicNamedAgentComponent.Requires<Msg,Ref> b) {
    fr.irit.smac.may.lib.classic.named.ClassicNamedAgentComponent.ComponentImpl<Msg,Ref> comp = new fr.irit.smac.may.lib.classic.named.ClassicNamedAgentComponent.ComponentImpl<Msg,Ref>(this, b, true);
