...
public abstract class ClassicBehaviour<Msg, Ref> {
  ...
  @SuppressWarnings("all")
  public static class ComponentImpl<Msg, Ref> implements fr.irit.smac.may.lib.classic.local.ClassicBehaviour.Component<Msg,Ref>, fr.irit.smac.may.lib.classic.local.ClassicBehaviour.Parts<Msg,Ref> {
    ...
    public ComponentImpl(final ClassicBehaviour<Msg,Ref> implem, final fr.irit.smac.may.lib.classic.local.ClassicBehaviour.Requires<Msg,Ref> b, final boolean initMakes) {
      this.bridge = b;
  ...
  public fr.irit.smac.may.lib.classic.local.ClassicBehaviour.Component<Msg,Ref> newComponent(final fr.irit.smac.may.lib.classic.local.ClassicBehaviour.Requires<Msg,Ref> b) {
    fr.irit.smac.may.lib.classic.local.ClassicBehaviour.ComponentImpl<Msg,Ref> comp = new fr.irit.smac.may.lib.classic.local.ClassicBehaviour.ComponentImpl<Msg,Ref>(this, b, true);
